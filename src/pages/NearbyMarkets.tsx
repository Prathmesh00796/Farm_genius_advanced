...
const NearbyMarkets: React.FC = () => {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          // In a real app, you would filter markets by distance from user location
        },
        (error) => {
  ...
  // Simulated distances (in a real app, calculate from user location)
  const getSimulatedDistance = (index: number) => {
